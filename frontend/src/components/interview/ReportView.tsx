      ...
      <nav className="nav" aria-label="Primary">
        <div className="nav-row">
          ...
          <div className="nav-actions">
            <button className="btn-icon" aria-label="Download PDF" onClick={handleExportPDF} disabled={exporting} title="Download PDF">
        ...
        <main className="container">
          ...
          <header className="page-head">
            ...
            <div className="page-head-actions">
              <button className="btn btn-ghost" type="button" onClick={handleExportPDF} disabled={exporting}>
          ...
          <section className="action-bar" aria-label="Decision actions">
            ...
            <div className="action-set">
              ...
              <button className="btn btn-primary" type="button" onClick={handleExportPDF} disabled={exporting}>
                {exporting ? "Exporting…" : "Export PDF"}
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/>
                  <polyline points="7 10 12 15 17 10"/>
